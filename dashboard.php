...
// Safe session variables with fallback
$adminName = $_SESSION['full_name'] ?? $_SESSION['email'] ?? 'Admin';
$adminRole = $_SESSION['role'] ?? 'admin';

// If full_name is missing from session, reload it from database
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="user-info">
            ...
            <div>
                <div style="font-weight:600;color:#333;"><?= htmlspecialchars($adminName) ?></div>
        ...
        <div class="custom-table">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>#<?= $c['id'] ?></td>
                        <td><?= htmlspecialchars($c['full_name'] ?? 'Unknown') ?></td>
